...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in a two String as an argument.
     *
     * @param first_part the first part of name of this Silly instance.
     * @param second_part the second part of name of this Silly instance.
     */
    public Silly(String first_part, String second_part){
